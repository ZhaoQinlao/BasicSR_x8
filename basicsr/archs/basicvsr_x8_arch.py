...
class BasicVSR_x8(nn.Module):
    ...
    def __init__(self, num_feat=64, num_block=15, spynet_path=None):
        ...
        self.upconv3 = nn.Conv2d(num_feat, 64 * 4, 3, 1, 1, bias=True)
    ...
    def forward(self, x):
        ...
        for i in range(0, n):
            ...
            base = F.interpolate(x_i, scale_factor=8, mode='bilinear', align_corners=False)
            out += base
            out_l[i] = out
